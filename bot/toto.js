...
var normalCommandsInfo = 'Commands: [disclaimer](command:disclaimer), ';
...
function handleControlText(from_address, text){
	...
	switch(wordOne){
		...
		default:
			return handleHeadlessText(from_address, text);
	}
}	
...
function handleHeadlessText(from_address, text){
	...
	switch(command){
		...
		default:
				return device.sendMessageToDevice(from_address, 'text', "unknown command; control commands: " + controlCommandsInfo);
	}
}
